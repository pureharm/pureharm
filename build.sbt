...
lazy val circeVersion:           String = "0.12.2"       //https://github.com/circe/circe/releases
lazy val pureconfigVersion:      String = "0.12.2"       //https://github.com/pureconfig/pureconfig/releases
lazy val slickVersion:           String = "3.3.2"        //https://github.com/slick/slick/releases
lazy val postgresqlVersion:      String = "42.2.9"       //java — https://github.com/pgjdbc/pgjdbc/releases
lazy val hikariCPVersion:        String = "3.4.2"        //java — https://github.com/brettwooldridge/HikariCP/releases
lazy val flywayVersion:          String = "6.0.6"        //java — https://github.com/flyway/flyway/releases
